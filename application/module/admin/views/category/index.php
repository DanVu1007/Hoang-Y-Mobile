...
<?php 
    ...
    $lblIcon  = Helper::cmsLinkSort('Icon','icon',$columnPost,$orderPost);
        ...
        <tbody>
            ...
            <?php 
                ...
                if(!empty($this->items)){
                    ...
                    $url_remove     = URL::createURL('admin','category','remove', array('id'=>$value['id']));
                    $btn_delete     = Helper::createButton('Xóa','#',$url_remove,'fas fa-trash-alt','danger','submit');     //delete each
                
                    $url_edit       = URL::createURL('admin','category','form', array('id'=>$value['id']));
                    $btn_edit       = Helper::createButton('Sửa','#',$url_edit,'fas fa-edit','primary');             //edit

                    $url_status     = URL::createURL('admin','category','ajaxStatus',array('id'=>$value['id'],'status'=> $value['status']));
                    ...
                    <tr>
                        ...
                        <td style="width: 10%;"><img src="<?php echo UPLOAD_URL.'category/'.$img  ?>" alt="" width="60%"></td> 
